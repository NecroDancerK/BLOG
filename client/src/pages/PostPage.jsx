  ...
  return (
    <div>
      ...
      <div className='flex gap-10 py-8'>
        ...
        <div className='w-1/3 p-8 bg-green-700 flex flex-col gap-2 rounded-sm'>
          <form
          ...
          >
            <input
              ...
              placeholder='Comment'
              className='text-black w-full rounded-sm bg-green-400 border p-2 text-xs outline-none placeholder:text-green-800'
            />
            <button
              type='submit'
